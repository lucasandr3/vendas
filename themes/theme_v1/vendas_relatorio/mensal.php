        ...
        <div class="card-header justify-content-between align-items-baseline">
            <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6" style="">
                    <a class="dropdown-item d-flex align-items-center" href="<?= url('imprimir/venda/diario/' . $dataFiltro[0] . "/loja") ?>" target="_blank">
                        <i data-feather='arrow-right'></i> Para Loja
                    </a>
                    <a class="dropdown-item d-flex align-items-center" href="<?= url('imprimir/venda/diario/' . $dataFiltro[0] . "/parceiro") ?>" target="_blank">
                        <i data-feather='arrow-right'></i> Para Fornecedor
                    </a>
                    <a class="dropdown-item d-flex align-items-center" href="<?= url('imprimir/venda/diario/' . $dataFiltro[0] . "/matriz") ?>" target="_blank">
                        <i data-feather='arrow-right'></i> Para Matriz
                    </a>
                </div>
            </div>
            <div>
                <p>Ou Informe um Período</p>
            </div>
            <form method="get" style="display: flex !important;">
            <div class="d-flex">
                    <input type="date" name="dataInicial" class="form-control" style="margin-right: 10px;"
                           value="<?= ($dataFiltro[0] !== "") ? $dataFiltro[0] : date('Y-m-d') ?>" />
                <input type="date" name="dataFinal" class="form-control" style="margin-right: 10px;"
                       value="<?= ($dataFiltro[1] !== "") ? $dataFiltro[1] : date('Y-m-d') ?>" />
            </div>
            ...
            <table class="table table-bordered table-striped mb-1" width="100%">
                ...
                <tr>
                    <th colspan="9" class="td-total-gray">Resumo financeiro Loja do dia
                        - <?= ($dataFiltro[0] === "") ? date('d/m/Y') : date('d/m/Y', strtotime($dataFiltro[0])) ?>
                        à <?= ($dataFiltro[1] === "") ? date('d/m/Y') : date('d/m/Y', strtotime($dataFiltro[1])) ?>
                    </th>
                </tr>
                <tr>
