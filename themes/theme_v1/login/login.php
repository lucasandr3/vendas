...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=url('assets/app/css/pages/page-auth.css')?>">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">LicitaMap</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?=url('assets/app/images/pages/login-v2.svg')?>" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h4 class="card-title mb-1">Bem Vindo ao LicitaMap! 👋</h4>
                                <p class="card-text mb-2">Faça Login para começar a aventura</p>
                                <form class="auth-login-form mt-2" action="<?=url('login/entrar')?>" method="POST">
                                    <div class="form-group">
                                        <label class="form-label" for="login-email">E-mail</label>
                                        <input class="form-control" id="login-email" name="email" type="text" name="login-email" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" name="password" id="login-password" type="password" name="login-password" placeholder="············" aria-describedby="login-password" tabindex="2" />
                                ...
                                <p class="text-center mt-2"><span>Novo por aqui ?</span><a href="page-auth-register-v2.html"><span>&nbsp;Cadastre-se aqui</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?=url('assets/app/js/scripts/pages/page-auth-login.js')?>"></script>
    <!-- END: Page JS-->
